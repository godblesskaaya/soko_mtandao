...
class HotelMockDataSource implements HotelDetailDataSource {
  ...
  Future<HotelModel> fetchHotelDetail(String hotelId) async {
    if (mockState == MockState.loading)
      return Future.delayed(Duration(seconds: 2), () => throw "Loading");
  ...
  Future<List<RoomModel>> fetchRoomAvailability(
    ...
    if (mockState == MockState.error)
      throw Exception("Room availability error");
    // return rooms based on offeringId

    List<RoomModel> rooms = [
      RoomModel(
          id: "r1", number: "101", status: RoomStatus.vacant, offeringId: "o1"),
      RoomModel(
          id: "r2", number: "102", status: RoomStatus.booked, offeringId: "o1"),
      RoomModel(
          id: "r3", number: "103", status: RoomStatus.vacant, offeringId: "o2"),
      RoomModel(
          id: "r4", number: "104", status: RoomStatus.vacant, offeringId: "o2"),
      RoomModel(
          id: "r5", number: "105", status: RoomStatus.vacant, offeringId: "o3"),
      RoomModel(
          id: "r6", number: "106", status: RoomStatus.vacant, offeringId: "o3"),
      RoomModel(
          id: "r7", number: "107", status: RoomStatus.vacant, offeringId: "o3"),
    ];
